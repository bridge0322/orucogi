    ...
    <svg viewBox="0 0 400 388" width="100%" height="100%" style={{ display: "block", overflow: "visible" }}>
      ...
      <g transform={`translate(0 ${-lift + sitDrop})`}>
        ...
        <g transform={`translate(200 150) scale(${0.78 + p.bodyScale * 0.22}) translate(-200 -150)`}>
          <path className="cr-ol" fill="#EDA94C" d={`M126 96 L${92 - earOutX} ${earTipY} L196 86 Z`}/>
          <path className="cr-ol" fill="#EDA94C" d={`M274 96 L${308 + earOutX} ${earTipY} L204 86 Z`}/>
          <path fill="#FBE3C9" d={`M138 92 L${118 - earOutX * 0.6} ${earTipY + 24} L182 86 Z`}/>
          <path fill="#FBE3C9" d={`M262 92 L${282 + earOutX * 0.6} ${earTipY + 24} L218 86 Z`}/>
